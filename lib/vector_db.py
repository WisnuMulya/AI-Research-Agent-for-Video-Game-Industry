...
class VectorStoreManager:
    ...
    def __init__(self, openai_api_key: str, is_persistent: bool = False, path: str = None):
        self.chroma_client = chromadb.PersistentClient(path=path) if is_persistent else chromadb.Client()
